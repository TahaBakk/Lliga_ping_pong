...
namespace Lliga_ping_pong
{
    public partial class Form1 : Form
    {
        ...
        List<string> resultados = new List<string>(); //Para poder almacenar en el firebase mas facilmente los datos
        ...
        private void Anadir(string nombre, string apellido)
        {
            //añadir jugadores
        ...
        private void button1_Click(object sender, System.EventArgs e)//añadir
        {
        ...
        private void button2_Click(object sender, System.EventArgs e)//eliminar
        {
            Eliminar();
        }

        private void button3_Click(object sender, System.EventArgs e)//actualizar
        {
            Actualizar();
        }

        private void button4_Click(object sender, System.EventArgs e)//limpiar
        {
        ...
        private void button5_Click(object sender, System.EventArgs e)//empezar liga
        {
        ...
        private void GestorPartidos(List<string> list)
        {
        ...
        private void button6_Click(object sender, System.EventArgs e)//Finalizar partido
        {
        ...
        private void Ganador(string gndr)
        {
            string ganador = gndr;
        ...
        private void button7_Click(object sender, EventArgs e)//cancelar liga
        {
